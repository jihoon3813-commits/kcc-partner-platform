...
function PartnerContractsContent() {
    ...
    const allMappedCustomers = useMemo(() => {
        ...
        const mapped = convexCustomers.map(c => {
            ...
            return {
                ...
                '시공일자': normalizeDate(contract?.constructionDate || c.construct_date), // 계약정보 시공일 우선
    ...
    }, [allMappedCustomers, searchTerm, statusFilter, categoryFilter, checklistFilter, sortOption, startDate, endDate]);
