...
function AdminContractsContent() {
    ...
    const allMappedCustomers = useMemo(() => {
        ...
        // "계약등록" 상태만 필터링 (전체 고객)
        const filtered = mapped.filter(c => String(c['진행구분']) === '계약등록');
            ...
            <div className="bg-white p-6 rounded-2xl border shadow-sm space-y-6">
                <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
                    <div>
                        ...
                        <p className="text-sm text-gray-500 font-medium mt-1">계약등록 상태인 전체 채널 고객의 계약 정보를 관리합니다.</p>
                    </div>
                ...
                <div className="grid grid-cols-1 gap-3">
                    <div className="relative group max-w-xl">
                        ...
                        <input
                            type="text"
                            placeholder="고객명, 연락처, 주소, 유입채널 검색..."
